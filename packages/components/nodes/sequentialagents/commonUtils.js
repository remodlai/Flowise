...
exports.checkMessageHistory = exports.RunnableCallable = exports.ExtractTool = exports.restructureMessages = exports.convertStructuredSchemaToZod = exports.customGet = exports.getVM = exports.processImageMessage = exports.transformObjectPropertyToFunction = exports.checkCondition = void 0;
...
const checkMessageHistory = async (nodeData, options, prompt, promptArrays, sysPrompt) => {
    ...
    if (messageHistory) {
        ...
        const vm = await (0, exports.getVM)(appDataSource, databaseEntities, nodeData, {});
        try {
