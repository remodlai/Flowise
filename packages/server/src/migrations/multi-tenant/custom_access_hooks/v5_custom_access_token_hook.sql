-- v5 of custom_access_token_hook function
-- This version ensures platform admins (superadmins) are properly identified
-- and have access to the global context
...
BEGIN
    ...
    BEGIN
        ...
        new_claims := jsonb_set(new_claims, '{app_metadata}', jsonb_build_object(
            ...
            'is_platform_admin', is_admin OR is_superadmin
        ));
