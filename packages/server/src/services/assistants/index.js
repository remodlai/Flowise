...
const importAssistants = async (newAssistants, queryRunner) => {
    try {
        const appServer = (0, getRunningExpressApp_1.getRunningExpressApp)();
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: assistantsService.importAssistants - ${(0, utils_2.getErrorMessage)(error)}`);
    }
};
const getChatModels = async () => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: assistantsService.getChatModels - ${(0, utils_2.getErrorMessage)(error)}`);
    }
};
const getDocumentStores = async () => {
    try {
        const appServer = (0, getRunningExpressApp_1.getRunningExpressApp)();
        const stores = await appServer.AppDataSource.getRepository(DocumentStore_1.DocumentStore).find();
        const returnData = [];
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: assistantsService.getDocumentStores - ${(0, utils_2.getErrorMessage)(error)}`);
    }
};
const getTools = async () => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: assistantsService.getTools - ${(0, utils_2.getErrorMessage)(error)}`);
    }
};
const generateAssistantInstruction = async (task, selectedChatModel) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: assistantsService.generateAssistantInstruction - ${(0, utils_2.getErrorMessage)(error)}`);
    }
};
exports.default = {
    createAssistant,
