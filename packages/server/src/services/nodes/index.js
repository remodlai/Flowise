...
const getAllNodes = async () => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: nodesService.getAllNodes - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
...
const getAllNodesForCategory = async (category) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: nodesService.getAllNodesForCategory - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
...
const getSingleNodeIcon = async (nodeName) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: nodesService.getSingleNodeIcon - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const getSingleNodeAsyncOptions = async (nodeName, requestBody) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: nodesService.getSingleNodeAsyncOptions - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
...
const executeCustomFunction = async (requestBody) => {
    try {
        ...
        const functionInputVariables = Object.fromEntries([...(body?.javascriptFunction ?? '').matchAll(/\$([a-zA-Z0-9_]+)/g)].map((g) => [g[1], undefined]));
        ...
        if (Object.prototype.hasOwnProperty.call(appServer.nodesPool.componentNodes, 'customFunction')) {
            try {
                ...
                const dbResponse = typeof returnData === 'string' ? (0, utils_1.handleEscapeCharacters)(returnData, true) : returnData;
                return dbResponse;
            }
            catch (error) {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: nodesService.executeCustomFunction - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
exports.default = {
    getAllNodes,
