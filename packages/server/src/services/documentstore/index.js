...
const createDocumentStore = async (newDocumentStore) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.createDocumentStore - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const getAllDocumentStores = async () => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.getAllDocumentStores - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const getAllDocumentFileChunks = async () => {
    try {
        const appServer = (0, getRunningExpressApp_1.getRunningExpressApp)();
        const entities = await appServer.AppDataSource.getRepository(DocumentStoreFileChunk_1.DocumentStoreFileChunk).find();
        return entities;
    }
    catch (error) {
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.getAllDocumentFileChunks - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const deleteLoaderFromDocumentStore = async (storeId, docId) => {
    try {
        const appServer = (0, getRunningExpressApp_1.getRunningExpressApp)();
        ...
        if (found) {
            if (found.files?.length) {
                for (const file of found.files) {
                    if (file.name) {
                        try {
                            await (0, storageUtils_1.removeSpecificFileFromStorage)(DOCUMENT_STORE_BASE_FOLDER, storeId, file.name);
                        }
                        catch (error) {
                            console.error(error);
                        }
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.deleteLoaderFromDocumentStore - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const getDocumentStoreById = async (storeId) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.getDocumentStoreById - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const getUsedChatflowNames = async (entity) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.getUsedChatflowNames - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
...
const getDocumentStoreFileChunks = async (appDataSource, storeId, docId, pageNo = 1) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.getDocumentStoreFileChunks - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const deleteDocumentStore = async (storeId) => {
    try {
        ...
        await (0, storageUtils_1.removeFilesFromStorage)(DOCUMENT_STORE_BASE_FOLDER, entity.id);
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.deleteDocumentStore - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const deleteDocumentStoreFileChunk = async (storeId, docId, chunkId) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.deleteDocumentStoreFileChunk - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const deleteVectorStoreFromStore = async (storeId) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.deleteVectorStoreFromStore - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const editDocumentStoreFileChunk = async (storeId, docId, chunkId, content, metadata) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.editDocumentStoreFileChunk - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const updateDocumentStore = async (documentStore, updatedDocumentStore) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.updateDocumentStore - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const _saveFileToStorage = async (fileBase64, entity) => {
    ...
    await (0, storageUtils_1.addSingleFileToStorage)(mime, bf, filename, DOCUMENT_STORE_BASE_FOLDER, entity.id);
    return {
        id: (0, uuid_1.v4)(),
        name: filename,
        mimePrefix: mime,
...
const _splitIntoChunks = async (appDataSource, componentNodes, data) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.splitIntoChunks - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const _normalizeFilePaths = async (appDataSource, data, entity) => {
        ...
        if (input.startsWith('FILE-STORAGE::')) {
            ...
            if (currentLoader) {
                ...
                for (const file of files) {
                    const bf = await (0, storageUtils_1.getFileFromStorage)(file, DOCUMENT_STORE_BASE_FOLDER, documentStoreEntity.id);
...
const previewChunksMiddleware = async (data) => {
    try {
        const appServer = (0, getRunningExpressApp_1.getRunningExpressApp)();
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.previewChunksMiddleware - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const previewChunks = async ({ appDataSource, componentNodes, data }) => {
    try {
        if (data.preview) {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.previewChunks - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
...
const saveProcessingLoader = async (appDataSource, data) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.saveProcessingLoader - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const processLoader = async ({ appDataSource, componentNodes, data, docLoaderId }) => {
    const entity = await appDataSource.getRepository(DocumentStore_1.DocumentStore).findOneBy({
        id: data.storeId
    });
    if (!entity) {
...
const processLoaderMiddleware = async (data, docLoaderId) => {
    try {
        const appServer = (0, getRunningExpressApp_1.getRunningExpressApp)();
        const appDataSource = appServer.AppDataSource;
        const componentNodes = appServer.nodesPool.componentNodes;
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.processLoader - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const _saveChunksToStorage = async (appDataSource, componentNodes, data, entity, newLoaderId) => {
    ...
    try {
                ...
                if (!data.rehydrated) {
                    if (loader.files) {
                        loader.files.map(async (file) => {
                            try {
                                await (0, storageUtils_1.removeSpecificFileFromStorage)(DOCUMENT_STORE_BASE_FOLDER, entity.id, file.name);
                            }
                            catch (error) {
                                console.error(error);
                            }
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices._saveChunksToStorage - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
...
const getDocumentLoaders = async () => {
    ...
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.getDocumentLoaders - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const updateDocumentStoreUsage = async (chatId, storeId) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.updateDocumentStoreUsage - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const updateVectorStoreConfigOnly = async (data) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.updateVectorStoreConfig - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const saveVectorStoreConfig = async (appDataSource, data, isStrictSave = true) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.saveVectorStoreConfig - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const insertIntoVectorStore = async ({ appDataSource, componentNodes, telemetry, data, isStrictSave }) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.insertIntoVectorStore - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
exports.insertIntoVectorStore = insertIntoVectorStore;
const insertIntoVectorStoreMiddleware = async (data, isStrictSave = true) => {
    try {
        const appServer = (0, getRunningExpressApp_1.getRunningExpressApp)();
        const appDataSource = appServer.AppDataSource;
        const componentNodes = appServer.nodesPool.componentNodes;
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.insertIntoVectorStoreMiddleware - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const _insertIntoVectorStoreWorkerThread = async (appDataSource, componentNodes, telemetry, data, isStrictSave = true) => {
    try {
        const entity = await saveVectorStoreConfig(appDataSource, data, isStrictSave);
        let upsertHistory = {};
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices._insertIntoVectorStoreWorkerThread - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
...
const getEmbeddingProviders = async () => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.getEmbeddingProviders - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
...
const getVectorStoreProviders = async () => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.getVectorStoreProviders - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
// Get all component nodes - Vector Stores
const getRecordManagerProviders = async () => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.getRecordManagerProviders - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const queryVectorStore = async (data) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.queryVectorStore - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
...
const upsertDocStore = async (appDataSource, componentNodes, telemetry, storeId, data, files = [], isRefreshExisting = false) => {
    ...
    if (files.length) {
        ...
        for (const file of files) {
            ...
            try {
                await (0, storageUtils_1.addArrayFilesToStorage)(file.mimetype, fileBuffer, file.originalname, fileNames, DOCUMENT_STORE_BASE_FOLDER, storeId);
            }
            catch (error) {
                continue;
            }
    ...
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.upsertDocStore - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const executeDocStoreUpsert = async ({ appDataSource, componentNodes, telemetry, storeId, totalItems, files, isRefreshAPI }) => {
    const results = [];
...
const upsertDocStoreMiddleware = async (storeId, data, files = []) => {
    const appServer = (0, getRunningExpressApp_1.getRunningExpressApp)();
    const componentNodes = appServer.nodesPool.componentNodes;
    const appDataSource = appServer.AppDataSource;
    const telemetry = appServer.telemetry;
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.upsertDocStoreMiddleware - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const refreshDocStoreMiddleware = async (storeId, data) => {
    const appServer = (0, getRunningExpressApp_1.getRunningExpressApp)();
    const componentNodes = appServer.nodesPool.componentNodes;
    const appDataSource = appServer.AppDataSource;
    const telemetry = appServer.telemetry;
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.refreshDocStoreMiddleware - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
const generateDocStoreToolDesc = async (docStoreId, selectedChatModel) => {
    try {
        ...
        throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Error: documentStoreServices.generateDocStoreToolDesc - ${(0, utils_3.getErrorMessage)(error)}`);
    }
};
