...
class UserController {
    ...
    static async getAllUsers(req, res) {
        try {
            ...
            const { data: allOrgUsers, error: allOrgUsersError } = await supabase_1.supabase
            ...
            const { data: organizations, error: orgsError } = await supabase_1.supabase
                .from('organizations')
                .select('*');
            if (orgsError) {
            ...
            // Get user profiles
            const { data: userProfiles, error: profilesError } = await supabase_1.supabase
                .from('user_profiles')
                .select('*');
            if (profilesError) {
            ...
            return (0, errorHandler_1.handleError)(res, error, 'Error fetching users');
        }
    }
    /**
    ...
    static async getUserById(req, res) {
        try {
            ...
            const { data: authUser, error: authError } = await supabase_1.supabase.auth.admin.getUserById(id);
            if (authError)
                throw authError;
            if (!authUser.user)
            ...
            if (!userRoles.length && id === req.user?.id) {
                ...
                const { data: userRolesData, error: rolesError } = await supabase_1.supabase
                    .from('user_roles')
                    .select(`
                        id,
                        resource_id,
            ...
            return (0, errorHandler_1.handleError)(res, error, 'Error fetching user');
        }
    }
    /**
     * Create a new user
    ...
    static async createUser(req, res) {
        try {
            ...
            return (0, errorHandler_1.handleError)(res, error, 'Error creating user');
        }
    }
    /**
    ...
    static async updateUser(req, res) {
        try {
            ...
            const { data, error } = await supabase_1.supabase.auth.admin.updateUserById(id, {
                email,
                password,
                user_metadata: {
                    first_name: firstName,
            ...
            const { data: existingProfile, error: checkError } = await supabase_1.supabase
                .from('user_profiles')
                .select('id')
                .eq('user_id', id)
                .single();
            ...
            return (0, errorHandler_1.handleError)(res, error, 'Error updating user');
        }
    }
    /**
     * Delete a user
    ...
    static async deleteUser(req, res) {
        try {
            ...
            return (0, errorHandler_1.handleError)(res, error, 'Error deleting user');
        }
    }
    /**
    ...
    static async getUserOrganizations(req, res) {
        try {
            ...
            return (0, errorHandler_1.handleError)(res, error, 'Error fetching user organizations');
        }
    }
}
