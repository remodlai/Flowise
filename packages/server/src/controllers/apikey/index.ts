...
const getAllApiKeys = async (req: Request, res: Response, next: NextFunction) => {
    try {
        const apiResponse = await apikeyService.getAllApiKeys(req)
...
const createApiKey = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const apiResponse = await apikeyService.createApiKey(req.body.keyName, req)
        return res.json(apiResponse)
    } catch (error) {
        next(error)
    }
...
const updateApiKey = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const apiResponse = await apikeyService.updateApiKey(req.params.id, req.body.keyName, req)
        return res.json(apiResponse)
    } catch (error) {
        next(error)
    }
...
const deleteApiKey = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const apiResponse = await apikeyService.deleteApiKey(req.params.id, req)
        return res.json(apiResponse)
    } catch (error) {
        next(error)
    }
