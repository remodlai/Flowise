...
exports.setupSupabaseStorage = void 0;
...
const setupSupabaseStorage = async () => {
    try {
        ...
        await createBucketIfNotExists(supabaseStorage_1.STORAGE_BUCKETS.PUBLIC, true);
        await createBucketIfNotExists(supabaseStorage_1.STORAGE_BUCKETS.PROFILES, false);
        await createBucketIfNotExists(supabaseStorage_1.STORAGE_BUCKETS.PLATFORM, false);
        await createBucketIfNotExists(supabaseStorage_1.STORAGE_BUCKETS.APPS, false);
        await createBucketIfNotExists(supabaseStorage_1.STORAGE_BUCKETS.ORGANIZATIONS, false);
        await createBucketIfNotExists(supabaseStorage_1.STORAGE_BUCKETS.USER_FILES, false);
...
exports.setupSupabaseStorage = setupSupabaseStorage;
/**
 ...
 */
const createBucketIfNotExists = async (bucketName, isPublic) => {
    try {
 ...
 */
const setupBucketPolicies = async (bucketName, isPublic) => {
    try {
      ...
      `;
        ...
        else if (bucketName === supabaseStorage_1.STORAGE_BUCKETS.PROFILES) {
      ...
      `;
        ...
        else if (bucketName === supabaseStorage_1.STORAGE_BUCKETS.PLATFORM) {
      ...
      `;
        ...
        else if (bucketName === supabaseStorage_1.STORAGE_BUCKETS.APPS) {
      ...
      `;
        ...
        else if (bucketName === supabaseStorage_1.STORAGE_BUCKETS.ORGANIZATIONS) {
      ...
      `;
        ...
        else if (bucketName === supabaseStorage_1.STORAGE_BUCKETS.USER_FILES) {
...
if (require.main === module) {
    (0, exports.setupSupabaseStorage)()
        .then(() => {
        console.log('Supabase Storage setup completed successfully');
        process.exit(0);
    })
...
//# sourceMappingURL=setupSupabaseStorage.js.map